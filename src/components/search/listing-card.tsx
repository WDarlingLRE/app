...
export function ListingCard({ listing }: ListingCardProps) {
  ...
  return (
    <Link
      href={href}
      className="group rounded-[30px] border border-black/10 bg-white/80 p-5 shadow-[0_18px_60px_rgba(16,16,16,0.06)] transition-transform duration-200 hover:-translate-y-1"
    >
      ...
      <div className="mt-6 flex items-center justify-between border-t border-black/8 pt-4 text-sm text-neutral-600">
